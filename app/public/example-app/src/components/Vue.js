...
module.exports = class Vue extends Component {
    ...
    register(options = {}) {
        ...
        this.version = new VueVersion(this.context).detect(
            ...
            use: [
                {
                    ...
                    options:
                        this.options.options || this.context.config.vue || {},
                },
            ],
        });
    ...
    styleChunkName() {
        ...
        if (this.options.extractStyles === true) {
            let chunk = this.context.chunks.find((chunk, id) =>
    ...
    extractFileName() {
        ...
        return fileName
            .replace(this.context.config.publicPath, "")
            .replace(/^\//, "");
    }
